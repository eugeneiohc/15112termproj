...
def titleRedrawAll(self, screen):
    ...
    self.textRectPlay = self.playButton.get_rect(center=(self.width / 2, textYShift * 3))  # play button
    self.textRectInstruct = self.instructButton.get_rect(center=(self.width / 2, textYShift * 4))  # instruct button
...
def instructionsRedrawAll(self, screen):
    ...
    textInstructions2 = self.instructions2.get_rect(center= \
                                                        (self.width / 2, textYShift * 3))  # instructions text
    textInstructions3 = self.instructions3.get_rect(center= \
